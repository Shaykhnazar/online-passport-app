...
//    use Authorizable;
    ...
    public function __construct()
    {
        ...
        $this->module_model = "Modules\Passport\Entities\Passport";
    }
    ...
    public function index_list(Request $request)
    {
        ...
        $query_data = $module_model::where('code', 'LIKE', "%$term%")->limit(5)->get();
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'code', 'type_id', 'user_id', 'expired_at' ,'updated_at');
        ...
        return Datatables::of($$module_name)
            ...
            ->editColumn('user_id', function ($data) {
                return $data->user->name. ' '.$data->user->first_name . ' '.$data->user->last_name;
            })
            ...
            ->editColumn('expired_at', function ($data) {
                ...
                $diff = Carbon::now()->diffInHours($data->expired_at);

                if ($diff < 25) {
                    return $data->expired_at->diffForHumans();
                } else {
                    return $data->expired_at->isoFormat('LLLL');
                }
            })
    ...
    public function create()
    {
        ...
        $users = User::get(['id', 'name'])->pluck('name','id');
        ...
        return view(
            ...
            compact('users','types', 'module_title', 'module_name', 'module_icon', 'module_name_singular', 'module_action')
        );
    }
