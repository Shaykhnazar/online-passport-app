...
//    use Authorizable;
    ...
    public function index()
    {
        ...
        $$module_name = $module_model::role('user')->paginate();

        Log::info("'$title' viewed by User:" . auth()->user()->name . '(ID:' . auth()->user()->id . ')');

        return view(
            "customers::backend.$module_path.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::role('user')->select('id', 'name', 'username', 'email', 'email_verified_at', 'updated_at', 'status');
        ...
        return Datatables::of($$module_name)
            ->addColumn('action', function ($data) {
                ...
                return view('customers::backend.includes.user_actions', compact('module_name', 'data'));
            })
    ...
    public function create()
    {
        ...
        return view(
            "customers::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "customers::backend.$module_name.show",
    ...
    public function profile(Request $request, $id)
    {
        ...
        return view("customers::backend.$module_name.profile", compact('user','module_name', 'module_name_singular', "$module_name_singular", 'module_icon', 'module_action', 'module_title', 'userprofile'));
    }
    ...
    public function profileEdit($id)
    {
        ...
        return view(
            "customers::backend.$module_name.profileEdit",
            compact('user', 'module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular", 'userprofile')
        );
    }
    ...
    public function changeProfilePassword($id)
    {
        ...
        return view("customers::backend.$module_name.changeProfilePassword", compact('user', 'module_name', 'module_title', "$module_name_singular", 'module_icon', 'module_action'));
    }
    ...
    public function changePassword($id)
    {
        ...
        return view(
            "customers::backend.$module_name.changePassword",
    ...
    public function edit($id)
    {
        ...
        return view(
            "customers::backend.$module_name.edit",
            compact('user','module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular")
        );
    }
    ...
    public function trashed()
    {
        ...
        return view(
            "customers::backend.$module_name.trash",
