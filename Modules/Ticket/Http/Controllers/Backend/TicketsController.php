...
//    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = __('labels.backend.tickets.name');
        ...
        // module icon
        $this->module_icon = 'fas fa-ticket-alt';
...
//        return response()->json($$module_name);
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'pass_type_id', 'user_id', 'status', 'updated_at', 'created_by');
        ...
        return Datatables::of($$module_name)
            ...
            ->editColumn('pass_type_id', function ($data){
    ...
    public function create()
    {
        ...
        $users = User::role('user')->get(['id', 'name'])->pluck('name','id');
